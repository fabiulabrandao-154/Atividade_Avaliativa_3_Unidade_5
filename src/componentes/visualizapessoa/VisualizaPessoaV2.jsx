          ...
          {tipo === "PF" ? (
            ...
            <>
              <Descriptions.Item label="Data de Registro">
                {pessoa.dataRegistro
                  ? new Date(pessoa.dataRegistro).toLocaleDateString("pt-BR")
                  : "Não informado"}
              </Descriptions.Item>
              <Descriptions.Item label="Inscrição Estadual">
                {pessoa.ie?.numero
                  ? `Nº ${pessoa.ie.numero} - ${pessoa.ie.estado} (${pessoa.ie.dataRegistro ? new Date(pessoa.ie.dataRegistro).toLocaleDateString("pt-BR") : ""})`
                  : "Não informado"}
              </Descriptions.Item>
            </>
          )}
